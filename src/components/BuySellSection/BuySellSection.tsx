            ...
            <div className="body-section display-flex-withspace">
                ...
                <div className="our-reserves-section">
                        <div className="">
                            ...
                            <p className="bold-currency">#3452030300303.24/$</p>
                        </div>
                        
                        <div className="display-flex-withspace"> 
                            <div className="display-flex">
                                    <img className="btc-logo" src="./vectors/bitcoin.svg" />
                                    <p className="btc-resrv-text">Bitcoin</p>
                            </div>
                            <div className="display-flex">
                                <p className="bold-currency">399.98</p>
                                <p>BTC</p>
                            </div>
                        </div>
                        ...
                        <div className="display-flex-withspace"> 
                            <div className="display-flex-withspace">
                                <img src="./vectors/etherum.svg" />
                                <p className="eth-resrv-text">Ethereum</p>
                            </div>
                            <div className="display-flex">
                                <p className="bold-currency">1000.00</p>
                                <p>ETH</p>
                            </div>
                        </div>
                </div>
